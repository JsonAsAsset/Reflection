...
UCLASS()
class REFLECTION_API UObjectSerializer : public UObject {
    GENERATED_BODY()
public:
    UObjectSerializer();
    ...
    /* New Generation */
    UObject* SpawnExport(FUObjectExport* Export, bool bOnlySerialize = false);

    /* Spawns exports as they are referenced */
